...
TRANSLATIONS = {
    "ru": {
        ...
        "lbl_thresh": "Чувствительность: {val}",
        "lbl_min_area": "Мин. площадь ({val}px²)",
        "lbl_padding": "Отступ от марки ({val}px)",
        "lbl_invert": "Тёмный фон скана",
        "help_thresh": "<b>Чувствительность</b>\n\nУправляет тем, насколько 'светлым' должен быть объект, чтобы программа его заметила.\n\n• <b>Больше</b> — выше порог (поможет, если лишний мусор на фоне обводится как марки).\n• <b>Меньше</b> — ниже порог (поможет, если темные или блеклые марки не находятся).",
        "help_min_area": "<b>Мин. площадь</b>\n\nОтсеивает мелкий мусор, пыль и помехи на скане.\n\n• Увеличьте, если программа обводит точки и пылинки.\n• Уменьшите, если на листе есть очень маленькие марки.",
    ...
    "en": {
        ...
        "lbl_thresh": "Sensitivity: {val}",
        "lbl_min_area": "Min Area ({val}px²)",
        "lbl_padding": "Stamp Padding ({val}px)",
        "lbl_invert": "Dark Scan Background",
        "help_thresh": "<b>Sensitivity</b>\n\nControls how 'bright' an object must be for the program to detect it.\n\n• <b>Higher</b> — stricter threshold (helps if background noise is detected as stamps).\n• <b>Lower</b> — more sensitive (helps if dark or faded stamps are ignored).",
        "help_min_area": "<b>Min Area</b>\n\nFilters out small noise, dust, and artifacts.\n\n• Increase if the program detects tiny dots or dust.\n• Decrease if you have very small stamps on the sheet.",
